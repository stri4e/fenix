...
public class MethodLogger {
    ...
    @Before(value = "@annotation(com.github.ethereum.utils.Logging)")
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.ethereum.utils.Logging)",
            returning = "result")
    ...
    @Around("@annotation(com.github.ethereum.utils.Logging)")
