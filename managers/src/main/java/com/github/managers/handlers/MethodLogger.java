package com.github.managers.handlers;
...
public class MethodLogger {
    ...
    @Before(value = "@annotation(com.github.managers.utils.Logging)")
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.managers.utils.Logging)",
            returning = "result")
    ...
    @Around("@annotation(com.github.managers.utils.Logging)")
