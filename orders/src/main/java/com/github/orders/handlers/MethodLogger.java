...
public class MethodLogger {
    ...
    @Before(value = "@annotation(com.github.orders.utils.Logging)")
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.orders.utils.Logging)",
            returning = "result")
    ...
    @Around("@annotation(com.github.orders.utils.Logging)")
