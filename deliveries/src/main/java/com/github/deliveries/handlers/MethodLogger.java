package com.github.deliveries.handlers;
...
public class MethodLogger {
    ...
    @Before(value = "@annotation(com.github.deliveries.utils.Logging)")
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.deliveries.utils.Logging)",
            returning = "result")
    ...
    @Around("@annotation(com.github.deliveries.utils.Logging)")
