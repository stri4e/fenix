package com.github.websocket.handlers;
...
public class MethodLogger {
    ...
    @Before(value = "@annotation(com.github.websocket.utils.Logging)")
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.websocket.utils.Logging)",
            returning = "result")
    ...
    @Around("@annotation(com.github.websocket.utils.Logging)")
