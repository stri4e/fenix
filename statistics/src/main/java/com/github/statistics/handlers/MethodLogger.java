package com.github.statistics.handlers;
...
public class MethodLogger {
    ...
    @Before(value = "@annotation(com.github.statistics.utils.Logging)")
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.statistics.utils.Logging)",
            returning = "result")
    ...
    @Around("@annotation(com.github.statistics.utils.Logging)")
