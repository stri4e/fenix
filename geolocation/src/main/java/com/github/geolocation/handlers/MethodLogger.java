package com.github.geolocation.handlers;
...
public class MethodLogger {
    ...
    @Before(value = "@annotation(com.github.geolocation.utils.Logging)")
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.geolocation.utils.Logging)",
            returning = "result")
    ...
    @Around("@annotation(com.github.geolocation.utils.Logging)")
