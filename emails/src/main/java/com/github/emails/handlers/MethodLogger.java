...
public class MethodLogger {
    ...
    @Before(value = "@annotation(com.github.emails.utils.Logging)")
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.emails.utils.Logging)",
            returning = "result")
    ...
    @Around("@annotation(com.github.emails.utils.Logging)")
