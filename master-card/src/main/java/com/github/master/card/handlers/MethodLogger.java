package com.github.master.card.handlers;
...
public class MethodLogger {
    ...
    @Before(value = "@annotation(com.github.master.card.utils.Logging)")
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.master.card.utils.Logging)",
            returning = "result")
    ...
    @Around("@annotation(com.github.master.card.utils.Logging)")
