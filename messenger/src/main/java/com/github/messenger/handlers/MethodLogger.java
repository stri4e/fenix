...
public class MethodLogger {
    ...
    @Before(value = "@annotation(com.github.messenger.utils.Logging)")
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.messenger.utils.Logging)",
            returning = "result")
    ...
    @Around("@annotation(com.github.messenger.utils.Logging)")
