package com.github.payments.handlers;
...
public class MethodLogger {
    ...
    @Before(value = "@annotation(com.github.payments.utils.Logging)")
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.payments.utils.Logging)",
            returning = "result")
    ...
    @Around("@annotation(com.github.payments.utils.Logging)")
