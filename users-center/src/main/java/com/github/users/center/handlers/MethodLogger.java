...
public class MethodLogger {
    ...
    @Before(value = "@annotation(com.github.users.center.utils.Logging)")
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.users.center.utils.Logging)",
            returning = "result")
    ...
    @Around("@annotation(com.github.users.center.utils.Logging)")
