...
public class MethodLogger {
    ...
    @Before(value = "@annotation(com.github.bitcoin.utils.Logging)")
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.bitcoin.utils.Logging)",
            returning = "result")
    ...
    @Around("@annotation(com.github.bitcoin.utils.Logging)")
